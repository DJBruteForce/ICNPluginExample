...
public class LoggableStatement implements PreparedStatement {
	...
	private static final org.apache.logging.log4j.Logger logger = org.apache.logging.log4j.LogManager.getLogger(LoggableStatement.class);
	...
	public void printSql(){
		...
		if(logger.isDebugEnabled()){
			logger.debug(" ###CLASS### "+Thread.currentThread().getStackTrace()[4].getClassName() + "." + Thread.currentThread().getStackTrace()[4].getMethodName()+" ###SQL### "+ getQueryString());
		}
	}
	/**
	 * JDBC 2.0
	...
	public boolean getMoreResults(int arg0) throws SQLException {
		// TODO Auto-generated method stub
		return wrappedStatement.getMoreResults(arg0);
	}
