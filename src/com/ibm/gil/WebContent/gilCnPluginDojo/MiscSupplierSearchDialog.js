define(["dojo/_base/lang",
        ...
        "dojo/text!./templates/MiscSupplierSearchDialog.html",
	    "dojox/grid/DataGrid",
	...
	var MiscSupplierSearchDialog =  declare("gilCnPluginDojo.MiscSupplierSearch", [ BaseDialog,GILDialog ], {
		...
		postCreate: function() {
			...
			this.setTitle("Suplier Search Results");
	...
	select : function(message) {
		...
		showSupplierSearchDataGrid: function() {
			...
			Request.postPluginService("GilCnPlugin", "MiscVendorSearchService",'application/x-www-form-urlencoded', {
		    	     ...
		    	     thisForm.destroyRecursive();
		    		    ...
		    		    var data = {
		    		    	    ...
		    		    	    var layout = [[
		    			    		    	      ...
		    			    		    	      {'name': 'Addr1', 			'field': 'addr1', 			'width': '210px'},
		    		    	    ...
		    		    	    grid1.placeAt("idMiscSearchVendor");    
		    		    	    grid1.startup();
		    		    	    this.grid = grid1;
		    		    	    this.show();
	    			}
	...
	return MiscSupplierSearchDialog;		
});
