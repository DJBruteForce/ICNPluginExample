package com.ibm.igf.webservice.security;
 ...
 * 
 * 
 * Usage example // Send message DatagramSocket socket = new DatagramSocket();
 * InetAddress address = InetAddress.getByName("ntp.cais.rnp.br"); byte[] buf =
 * new NtpMessage().toByteArray(); DatagramPacket packet = new
 * DatagramPacket(buf, buf.length, address, 123); socket.send(packet); // Get
 * response socket.receive(packet); System.out.println(msg.toString());
 * 
 * 
...
public class NtpMessage {
    ...
    public static String timestampToString(double timestamp)
    {
        ...
        String date = dateFormatter.format(new Date(ms));
